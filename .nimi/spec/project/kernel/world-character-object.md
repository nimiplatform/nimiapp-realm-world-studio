...
- **[R-RWS-CHARACTER-004]** Display name, handle, description, greeting, media, voice, character relationships, source profile, and readiness fields must be read from WorldCharacterCore.core when present; entity-backed identity and facts must come from the WorldEntityCore resolved by WorldCharacterCore.entityId.
